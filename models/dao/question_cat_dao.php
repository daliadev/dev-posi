...
class QuestionCategorieDAO extends ModelDAO
{
	...
	public function update($values) 
	{
		...
		if (!empty($values))
		{
			if (isset($values['id_question_cat']) && !empty($values['id_question_cat']) && isset($values['ref_question']) && !empty($values['ref_question']) && isset($values['ref_cat']) && !empty($values['ref_cat']))
			{
