...
VALUES 	(1, 1, 1, 'qcm', 'Comment s&#39;appelle ce type de document ?', 'img_1.jpg', 'audio_1.mp3'),
		(2, 2, 2, 'qcm', 'Retrouvez votre point d&#39;arrivÃ©e sur le plan.', 'img_3.jpg', 'audio_3.mp3'),
		(3, 2, 3, 'qcm', 'Vous commencez le travail Ã  8 heures. Pour Ãªtre sÃ»r de ne pas Ãªtre en retard, vous partez 45 minutes plus tÃ´t. A quelle heure partez-vous ?', 'img_6.jpg', 'audio_6.mp3'),
		(4, 2, 4, 'champ_saisie', 'Avant de partir de chez vous, vous Ã©crivez un message Ã  votre conjoint (e) pour lui demander d&#39;acheter du pain et lui dire Ã  quelle heure vous rentrerez ce soir. Ecrivez votre message ci-dessous :', 'img_7.jpg', 'audio_7.mp3'),
		(5, 1, 5, 'qcm', 'Vous Ãªtes arrivÃ© au lycÃ©e dans lequel vous travaillez. Que signifie ce panneau ?', 'img_8.jpg', 'audio_8.mp3'),
		(6, 3, 6, 'qcm', 'Vous gagnez 9,50 euros de l&#39;heure. Vous avez travaillÃ© 100 heures dans le mois. Combien allez-vous gagner ?', 'img_29.jpg', 'audio_29.mp3'),
