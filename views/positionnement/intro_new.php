...
<script type="text/javascript"> 
			if(FlashDetect.installed){
					var lecteurfla;
					 ...
					 lecteurfla += '<param name="flashvars" value="mp3=<?php echo SERVER_URL; ?>media/mp3/intro.mp3&amp;autostart=1&amp;nopointer=1" />';
					 lecteurfla += '</object>';
					...
					var lecteurhtml;
					 lecteurhtml = '<audio preload="auto" ontimeupdate="update(this)" src="<?php echo SERVER_URL; ?>media/mp3/intro.mp3" autoplay controls ></audio>';
